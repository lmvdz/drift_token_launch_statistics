...
(async () => {
    ...
    if (idl) {
        ...
        console.log()
        console.log('Unclaimed', new Intl.NumberFormat("en-US", { style: 'currency', currency: 'USD' }).format(120000000 - totalForgone.add(totalClaimed).toNumber()).replace('$', 'DRIFT '))
        console.log('% Unclaimed', (((120000000 - totalClaimed.add(totalForgone).toNumber()) / 120000000) * 100).toFixed(2) + '%' )
    }
})();
